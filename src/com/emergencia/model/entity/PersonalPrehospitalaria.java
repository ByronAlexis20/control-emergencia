...
@NamedQueries({
	...
	@NamedQuery(name="PersonalPrehospitalaria.buscarPorBombero", query="SELECT p FROM PersonalPrehospitalaria p where p.estado = 'A' and p.bombero.idUsuario = :idBombero")
})
