...
public class PerfilLista {
	...
	@Command
	public void nuevo(){
		Window ventanaCargar = (Window) Executions.createComponents("/forms/seguridad/perfilEditar.zul", null, null);
	...
	public void editar(@BindingParam("perfil") Perfil perfilSeleccionado){
		...
		Window ventanaCargar = (Window) Executions.createComponents("/forms/seguridad/perfilEditar.zul", null, params);
		ventanaCargar.doModal();
	}
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@Command
