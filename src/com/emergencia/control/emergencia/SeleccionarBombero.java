...
public class SeleccionarBombero {
	...
	NuevaEmergencia registroEmergencia;
	...
	public void aferCompose(@ContextParam(ContextType.VIEW) Component view) throws IOException{
		...
		registroEmergencia = (NuevaEmergencia) Executions.getCurrent().getArg().get("NuevaEmergencia");
			...
			public void onEvent(Event event) throws Exception {
				if (event.getName().equals("onYes")) {		
					try {
						...
						PersonalEmergencia per = new PersonalEmergencia();
						per.setBombero(usu);
						per.setEstado("A");
						per.setIdPersonalEmergencia(null);
						per.setEmergencia(emergencia);
						registroEmergencia.agregarBombero(per);
						salir();
					} catch (Exception e) {
	...
	public List<Usuario> getListaBomberosAgregados() {
		return listaBomberosAgregados;
	}

	public void setListaBomberosAgregados(List<Usuario> listaBomberosAgregados) {
		this.listaBomberosAgregados = listaBomberosAgregados;
	}
